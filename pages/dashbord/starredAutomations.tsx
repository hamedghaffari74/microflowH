        ...
        <div>
          ...
          <div className="flex justify-center mt-10 items-center">
            <Box
              ...
              <Star1 />
              <Typography className="text-title ml-2 "> Starred automations</Typography>
              </div>
            </Box>
          ...
          <div className="flex justify-end mt-10 float-right w-7/12 mr-52" >
            <Grid className="justify-start  " container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 16 }}>
              {test1.map((option) =>option.star ==true ?
                <Grid item xs={6}>
                  ...
                  <Grid container>
                    ...
                    <div>
                      <div className=" flex ml-5  items-center">
                        ...
                        <div className={` Button-label ${option.label_text == "Active" ? "text-[#00A372]" : option.label_text == "Failed" ? "text-[#B52C3E]" : option.label_text == "Paused" ? "text-[#E6660A]" : "hidden"}`}>
...
export default StarredAutomations
